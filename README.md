...
- Expo app: Feed; Events with iyzico ticketing, QR check-in, and attendance;
  Explore (mini-games, Radio and Podcasts via Spotify); Shop
...
- React Native reels editor: hypes, search and filter, authentication, paywall,
...
- Cheer Media - IT Consultant (part-time) | Jan 2020 - Jan 2022: Benchmark
  Email setup; 6 Next.js newsletter signup sites; Lighthouse 90+.
- KmkocSoftware - Founder and CTO | Jan 2023 - Jan 2024: Client dashboard for
  Rational devices; Firebase Cloud Functions API; React dashboard.
